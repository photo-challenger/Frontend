		...
		<Animated.ScrollView style={{ padding: 24 }}>
			<View style={{ paddingBottom: 48 }}>
				...
				<ContentText>{'\t'}위치정보의 보호 및 이용 등에 관한 법률에 따라 회원의 개인위치정보를 안전하게 관리합니다.
					...
					{'\n\n'}트립쳐는 위치정보의 보호 및 이용 등에 관한 법률 제16조 제2항에 따라 회원의 위치정보를 처리합니다. 단말에서 사용된 위치 정보는 서비스 제공 후 즉시 파기되며, 관련 정보는 한국관광공사의 국문 관광정보 오픈 API로 전송됩니다. 트립쳐는 위치정보 수집·이용·제공 사실과 관련된 자료를 별도로 저장하지 않으며, 위치 정보는 일시적으로만 이용됩니다.
					{'\n\n\t\t'}2. 개인위치정보의 파기 절차 및 방법
